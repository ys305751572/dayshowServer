            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="productForm" method="post" enctype="multipart/form-data" action="admin/share/save" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control input-sm" id="level" name="level" value ="${share.level}">
