            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="admin/share/add" target="_blank" class="btn btn-outline btn-primary btn-lg"
                           role="button">新增模板</a>
                    </div>
...
//                        }
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href", 'admin/share/add?id=' + data.id);
...
//                        }
            ...
            settingAdded: function (data) {
                $bluemobi.optNotify(function () {
                    $bluemobi.ajax("admin/share/delete", {id: JSON.stringify(data.id)}, function (result) {
