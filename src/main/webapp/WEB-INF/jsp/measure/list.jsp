            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <form class="navbar-form navbar-right" role="search">
                        ...
                        <div class="form-group">
                            <label>测试部位</label>
                            <select class="form-control input-sm" id="part">
                                <option value="" selected="selected">全部</option>
                                <option value="0">颈部</option>
                                <option value="1">手部</option>
                                <option value="2">脸部</option>
                            </select>
                        </div>
...
//                        }
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href",'admin/measure/add?id='+data.id);
                    },
