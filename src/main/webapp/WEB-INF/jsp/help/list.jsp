            ...
            dataTableInit: function () {
                kuserList.v.dTable = $bluemobi.dataTable($('#dataTables'), {
                    ...
                    "columns": [
                        ...
                        {"data": "updateDate", render : function(data) {return new Date(data).format("yyyy-MM-dd")}},
                        {"data":""}
                    ],
                    "columnDefs": [
                        {
...
//                        }
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".add").attr("href", 'admin/help/add?id=' + data.id);
                        $('td', row).last().find(".edit").attr("href", 'admin/help/detail?id=' + data.id);
...
//                    },
            ...
            settingAdded: function (data) {
                $bluemobi.optNotify(function () {
                    $bluemobi.ajax("admin/help/delete", {id: JSON.stringify(data.id)}, function (result) {
