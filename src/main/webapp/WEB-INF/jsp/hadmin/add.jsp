            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" enctype="multipart/form-data" action="admin/hadmin/save" class="form-horizontal" role="form">
                            <input type="hidden" id="id" name="id" value="${admin.id}">
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">姓名:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="name" name="name" maxlength="20"
                                           data-rule="required" value="${admin.name}" placeholder="请输入姓名">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="username" name="username" maxlength="20"
                                           data-rule="required" value="${admin.username}" placeholder="请输入账号">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">电话号码:</label>
                                <div class="col-sm-3">
                                    <input id="mobile" class="form-control" placeholder="电话号码" data-rule="电话号码: required; digits; length[11]" maxlength="11" data-msg-digits="{0}只能使用纯数字" data-msg-length="{0}请输入11位" name="mobile" type="mobile" value="${admin.mobile}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">密码:</label>
                                <div class="col-sm-3">
                                    <input id="password" class="form-control" placeholder="密码" data-rule="密码: required; !digits; length[6~15]" maxlength="15" data-msg-digits="{0}不能使用纯数字" data-msg-length="{0}请输入6~15位" name="password" type="password" value="${admin.password}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">确认密码:</label>
                                <div class="col-sm-3">
                                    <input data-rule="确认密码: required;match(password);" class="form-control" placeholder="确认密码" data-rule="required" type="password" value="${admin.password}"/>
                                </div>
                            </div>
                            <div class="form-group">
...
//                    $("#id").val(result.data.id)
                        window.location.href = " ${contextPath}/admin/hadmin/index";
                } else {
