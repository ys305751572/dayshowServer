            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="infoForm" method="post" enctype="multipart/form-data">
                        <h4>
                            <input type="text" id="value1" name="value1" size="3"/>
                            % ~
                            <input type="text" id="value2" name="value2" size="3"/>
                            %
                        </h4>
                    </form>
                </div>
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            render : function(data, type ,row) {
                                return data.moistureDown + "% ~" +data.moistureUp + "%" + "&nbsp;&nbsp;&nbsp;<a  title='更改'  class='btn btn-primary btn-circle showModel'><i class='fa fa-pencil-square-o'></i></a>";
                            }
                        },
                        {
                            data : null,
                            render : function(data ,type ,row) {
                                return data.greaseDown + "% ~ " + data.greaseUp + "% &nbsp;&nbsp;&nbsp;<a  title='更改'  class='btn btn-primary btn-circle showModel'><i class='fa fa-pencil-square-o'></i></a>"
                            }
                        },
                        {"data": ""}
                    ],
...
//                        kuserList.v.list.push(data);
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".add").attr("href",'admin/measureConfig/add?id='+data.id + "&part=" + data.part);
            ...
            subInfo: function () {
                ...
                if (flag) {
                    ...
                    $("#infoForm").ajaxSubmit({
                        url: _basePath + "admin/measureConfig/saveConfig",
                        dataType: "json",
                        data: {
                        ...
                        success: function (result) {
                            if (result.status == 0) {
                                console.log("success")
                                window.location.href = _basePath + "admin/measureConfig/index";
                            } else {
